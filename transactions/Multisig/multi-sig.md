flow transactions build transactions/OracleAdmin/link_and_publish_data_updater_capability.cdc --args-json "$(cat transactions/OracleAdmin/publish_args.json)" --network testnet --proposer bun-test1 --payer bun-test1 --authorizer bun-test1 --filter payload --save tx1 -y
